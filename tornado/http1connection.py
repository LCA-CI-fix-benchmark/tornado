...
from tornado.util import GzipDecompressornsed under the Apache License, Version 2.0 (the "License"); you may
...
# distr        lines = [line.encode("latin1") for line in header_lines]
        for line in lines:uted under the License is distributed on an "AS IS" BASIS, WITHOUT
